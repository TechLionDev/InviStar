...
function SortNFilter({
	...
	sortProperty: keyof Product | 'default';
	setSortProperty: (property: keyof Product | 'default') => void;
	...
	return (
		<CredenzaContent>
			<CredenzaHeader className='mb-6'>
				...
				<CredenzaDescription>
					Apply filters and sorting to find products quickly.
				</CredenzaDescription>
			</CredenzaHeader>
