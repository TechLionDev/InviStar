...
function SortNFilter({
	...
	sortProperty: keyof Order | 'default';
	setSortProperty: (property: keyof Order | 'default') => void;
	...
	return (
		<CredenzaContent>
			<CredenzaHeader className='mb-6'>
				...
				<CredenzaDescription>
					Apply filters and sorting to find orders quickly.
				</CredenzaDescription>
			</CredenzaHeader>
